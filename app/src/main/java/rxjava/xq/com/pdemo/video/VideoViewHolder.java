...
import rxjava.xq.com.pdemo.video.model.VideoLoadMvpView;
import rxjava.xq.com.pdemo.video.target.VideoLoadTarget;
import rxjava.xq.com.pdemo.video.target.VideoProgressTarget;
...
//    public TextView videoTitle;
    ...
    public VideoViewHolder(View view) {
        super(view);
//        videoView = (TextureVideoView) view.findViewById(R.id.player);
////        videoTitle = (TextView) view.findViewById(R.id.video_text);
//        videoCover = (ImageView) view.findViewById(R.id.cover);
//        progressBar = (CircularProgressBar) view.findViewById(R.id.pb_progress);
